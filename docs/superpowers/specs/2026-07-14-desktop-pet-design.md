...
### 7.13 不采纳: Failure (刻意犯错)

GPT 提议偶尔让她故意记错小事以增加真实感。**不采纳。**

理由: 与 Grounded Generation 第一铁律直接冲突。我们花了大量精力确保她不编造记忆, 刻意注入错误会磨损信任基石。自然发生的失误 (LLM 偶尔出错) 由 Correction Loop 优雅处理, 已足够。
